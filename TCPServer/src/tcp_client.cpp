...
/*
 * Uses socket command to create a new socket for the client.
...
/*
 * Uses inet_aton command to convert Internet host address intp binary form. 
 * Confused what this does, tbh, need more documentation. 
 */
